<h2><a href="https://leetcode.com/problems/maximum-product-difference-between-two-pairs/?envType=problem-list-v2&envId=sorting">2042. Maximum Product Difference Between Two Pairs</a></h2><h3>Easy</h3><hr><p>The <strong>product difference</strong> between two pairs <code>(a, b)</code> and <code>(c, d)</code> is defined as <code>(a * b) - (c * d)</code>.</p>
